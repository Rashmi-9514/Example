    ...
    show_Selected_Category = (item) => {
        switch (item) {
            ...
            case 4:
                ...
                break;
            case 5:
                CleverTap.profileAddMultiValueForKey('MBA', 'Education');
                break;
            case 500:
    ...
    constructor() {
        ...
        const array = [
...

            {
                ...
                sub_Category: [{ id: 22, name: 'pushEvent' },{ id: 221, name: 'pushEventwithprops' }, { id: 23, name: 'pushChargedEvent' }]
            },
...
pusheventwithprops = () => {
    alert('Event with Properties Recorded');

    //Recording an Event
    CleverTap.recordEvent('testEventWithProps', {'Product Name': 'Dairy Milk','Category': 'Chocolate','Amount': 20.00});
    // CleverTap.recordEvent('testEventWithProps', { 'start': new Date(), 'foo': 'bar' });
};
